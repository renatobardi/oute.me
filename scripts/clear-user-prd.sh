#!/usr/bin/env bash
# Apaga entrevistas, projetos e documentos GCS de um usuário no banco PROD.
# Uso: ./scripts/clear-user-prd.sh <email>
#
...
PROXY_PORT=15432
DB_URL="postgresql://postgres:wazjin-corfi0-cYdbav-hkutX@localhost:${PROXY_PORT}/oute_production"
...
echo "▶ Limpando dados de [PROD] para: $EMAIL"
